  ...
  */
  ...
  var ImageDialog = /** @class */ (function () {
      ...
      ImageDialog.prototype.initialize = function () {
          ...
          var body = [
              '<div class="custom-file note-form-group note-group-select-from-files mb-3">',
              '<input class="custom-file-input note-image-input form-control-file note-form-control note-input" type="file" name="files" accept="image/*" multiple="multiple">',
              '<label class="custom-file-label text-truncate note-form-label">' + this.lang.image.selectFromFiles + '</label>',
              imageLimitation,
              '</div>',
